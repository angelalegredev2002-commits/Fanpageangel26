export const Icons = {
  ...
  tiktokFooter: {
    paths: [
      {
        d: 'M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.81-.73-3.89-1.74-.01.31-.03.6-.03.93v7.37c.01 3.34-2.18 6.51-5.41 7.29-3.23.78-6.84-.71-8.31-3.79-1.47-3.07-.31-7.07 2.6-8.77.94-.55 1.99-.81 3.08-.79v4.11c-.72-.05-1.46.12-2.06.52-1.39.91-1.78 2.89-.88 4.28.9 1.39 2.88 1.78 4.28.88.58-.38.93-1.01.94-1.7V.02Z',
      },
    ],
    class:
      'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
  ...
  whatsappFooter: {
    paths: [
      {
        d: 'M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.445 0 .081 5.363.077 11.971c0 2.112.551 4.171 1.597 6.026L0 24l6.197-1.625a11.838 11.838 0 005.851 1.55h.005c6.603 0 11.967-5.364 11.97-11.972a11.79 11.79 0 00-3.492-8.455',
      },
    ],
    class:
      'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
